    ...
    formState: {
      selectOptionsData: {
        Capacitacion: [
          ...
          {id: 'Ingles', name: 'Ingles', idSector: 'Centros de contacto'},
          {id: 'Nuevas tecnologías', name: 'Nuevas tecnologías', idSector: 'Centros de contacto'},
          ...
          },
          {
            ...
            templateOptions: {
              ...
              options:[
                ...
                {id: 'Centros de contacto', name: 'Centros de contacto'},
              ],
              valueProp: 'id',
              labelProp: 'name'
            }
